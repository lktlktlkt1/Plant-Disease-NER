...
for conf in MODEL_CONFIG_CLASSES:
    try:
        pretrained_models = conf.pretrained_config_archive_map.keys()
        ALL_MODELS.extend(pretrained_models)
    except AttributeError:
        # Handle the case where the configuration does not have pretrained_config_archive_map
        pass
